...
<form method="post" action="site-info.php?action=update-site">
 ...
 if ( $is_main_site ) : ?>
		...
		<?php
 $site_attributes_title = __( 'Attributes' ); $attribute_fields = array( 'public' => _x( 'Public', 'site' ) ); if ( ! $is_main_site ) { $attribute_fields['archived'] = __( 'Archived' ); $attribute_fields['spam'] = _x( 'Spam', 'site' ); $attribute_fields['deleted'] = __( 'Flagged for Deletion' ); } $attribute_fields['mature'] = __( 'Mature' ); ?>
		<tr>
