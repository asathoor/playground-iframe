...
<div class="theme<?php echo $active_class; ?>">
 ...
 $aria_label = sprintf( _x( 'Cannot Activate %s', 'theme' ), '{{ data.name }}' ); ?>
			...
			<?php
 if ( current_user_can( 'edit_theme_options' ) && current_user_can( 'customize' ) ) { $live_preview_aria_label = sprintf( _x( 'Live Preview %s', 'theme' ), '{{ data.name }}' ); ?>
