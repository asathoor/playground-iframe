<?php
 require_once __DIR__ . '/admin.php'; if ( isset( $_GET['privacy-notice'] ) ) { wp_redirect( admin_url( 'privacy.php' ), 301 ); exit; } $title = __( 'Freedoms' ); list( $display_version ) = explode( '-', get_bloginfo( 'version' ) ); $header_alt_text = sprintf( __( 'WordPress %s' ), $display_version ); require_once ABSPATH . 'wp-admin/admin-header.php'; ?>
