...
<div id="dashboard-widgets" class="metabox-holder<?php echo $columns_css; ?>">
 ...
 if ( ! empty( $response['recommended_version'] ) ) { printf( __( 'The minimum recommended version of PHP is %s.' ), $response['recommended_version'] ); } ?>
	...
	<p class="button-container">
		<?php
 printf( '<a class="button button-primary" href="%1$s" target="_blank">%2$s<span class="screen-reader-text"> %3$s</span><span aria-hidden="true" class="dashicons dashicons-external"></span></a>', esc_url( wp_get_update_php_url() ), __( 'Learn more about updating PHP' ), __( '(opens in a new tab)' ) ); ?>
	</p>
	<?php
 ...
 printf( _n( 'Take a look at the <strong>%1$d item</strong> on the <a href="%2$s">Site Health screen</a>.', 'Take a look at the <strong>%1$d items</strong> on the <a href="%2$s">Site Health screen</a>.', $issues_total ), $issues_total, esc_url( admin_url( 'site-health.php' ) ) ); ?>
	...
	<?php
} function wp_dashboard_empty() {} function wp_welcome_panel() { list( $display_version ) = explode( '-', wp_get_wp_version() ); $can_customize = current_user_can( 'customize' ); $is_block_theme = wp_is_block_theme(); ?>
