...
<table class="links-table">
	...
	<?php $identity_group_title = __( 'identity' ); ?>
	<tr>
	...
	<?php $friendship_group_title = __( 'friendship' ); ?>
	<tr>
		...
		<td><fieldset>
			...
			<input name="friendship" type="radio" class="valinp" value="" id="friendship" <?php xfn_check( 'friendship' ); ?> />&nbsp;<?php  _ex( 'none', 'Type of relation' ); ?>
			</label>
		</fieldset></td>
	</tr>
	<?php $physical_group_title = __( 'physical' ); ?>
	<tr>
	...
	<?php $professional_group_title = __( 'professional' ); ?>
	<tr>
	...
	<?php $geographical_group_title = __( 'geographical' ); ?>
	<tr>
		...
		<td><fieldset>
			...
			<input class="valinp" type="radio" name="geographical" value="" id="geographical" <?php xfn_check( 'geographical' ); ?> />&nbsp;<?php  _ex( 'none', 'Type of relation' ); ?>
			</label>
		</fieldset></td>
	</tr>
	<?php $family_group_title = __( 'family' ); ?>
	<tr>
		...
		<td><fieldset>
			...
			<label for="family">
			<input class="valinp" type="radio" name="family" value="" id="family" <?php xfn_check( 'family' ); ?> />&nbsp;<?php  _ex( 'none', 'Type of relation' ); ?>
			</label>
		</fieldset></td>
	</tr>
	<?php $romantic_group_title = __( 'romantic' ); ?>
	<tr>
