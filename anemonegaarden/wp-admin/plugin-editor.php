...
<h2>
	<?php
 if ( is_plugin_active( $plugin ) ) { if ( is_writable( $real_file ) ) { printf( __( 'Editing %s (active)' ), '<strong>' . esc_html( $plugin_name ) . '</strong>' ); } else { printf( __( 'Browsing %s (active)' ), '<strong>' . esc_html( $plugin_name ) . '</strong>' ); } } else { if ( is_writable( $real_file ) ) { printf( __( 'Editing %s (inactive)' ), '<strong>' . esc_html( $plugin_name ) . '</strong>' ); } else { printf( __( 'Browsing %s (inactive)' ), '<strong>' . esc_html( $plugin_name ) . '</strong>' ); } } ?>
</h2>
<?php
printf( ' <span><strong>' . __( 'File: %s' ) . '</strong></span>', esc_html( $file ) ); ?>
</div>
