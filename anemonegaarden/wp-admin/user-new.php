...
<table class="form-table" role="presentation">
 ...
 do_action( 'user_new_form', 'add-existing-user' ); ?>
	...
	<?php
} if ( current_user_can( 'create_users' ) ) { if ( $do_both ) { echo '<h2 id="create-new-user">' . __( 'Add User' ) . '</h2>'; } ?>
