<?php
					...
					<?php if ( get_option( 'show_avatars' ) ) : ?>
						<tr class="user-profile-picture">
							...
							<td>
								...
								<p class="description">
									<?php
 if ( IS_PROFILE_PAGE ) { $description = sprintf( __( '<a href="%s">You can change your profile picture on Gravatar</a>.' ), __( 'https://gravatar.com/' ) ); } else { $description = ''; } echo apply_filters( 'user_profile_picture_description', $description, $profile_user ); ?>
								</p>
							</td>
						</tr>
					<?php endif; ?>
 ...
 $application_passwords_list_table = _get_list_table( 'WP_Application_Passwords_List_Table', array( 'screen' => 'application-passwords-user' ) ); $application_passwords_list_table->prepare_items(); $application_passwords_list_table->display(); ?>
							...
							<?php elseif ( ! wp_is_application_passwords_supported() ) : ?>
								...
								<p>
									<?php
 printf( __( 'If this is a development website, you can <a href="%s">set the environment type accordingly</a> to enable application passwords.' ), __( 'https://developer.wordpress.org/apis/wp-config-php/#wp-environment-type' ) ); ?>
								</p>
							<?php endif; ?>
						</div>
					<?php endif; ?>
