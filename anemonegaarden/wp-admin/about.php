<?php
 require_once __DIR__ . '/admin.php'; $title = _x( 'About', 'page title' ); list( $display_version ) = explode( '-', wp_get_wp_version() ); $display_major_version = '6.9'; $release_notes_url = sprintf( __( 'https://wordpress.org/documentation/wordpress-version/version-%s/' ), sanitize_title( $display_major_version ) ); $field_guide_url = sprintf( __( 'https://make.wordpress.org/core/wordpress-%s-field-guide/' ), sanitize_title( $display_major_version ) ); $release_page_url = sprintf( __( 'https://wordpress.org/download/releases/%s/' ), sanitize_title( $display_major_version ) ); require_once ABSPATH . 'wp-admin/admin-header.php'; ?>
 ...
 printf( __( 'WordPress %s' ), $display_version ); ?>
		...
		<div class="about__section has-2-columns is-wider-left is-feature" style="background-color:var(--background);border-radius:var(--border-radius);">
			...
			<div class="column">
				<p>
					<?php
 printf( __( 'For a comprehensive overview of all the new features and enhancements in WordPress %s, please visit the feature-showcase website.' ), $display_major_version ); ?>
				</p>
			</div>
		...
		<div class="about__section has-3-columns">
			...
			<div class="column is-vertically-aligned-center" style="grid-column-end:span 2">
				<h3>
					<?php
 printf( __( 'Learn more about WordPress %s' ), $display_major_version ); ?>
				</h3>
				<p>
					<?php
			...
			<div class="column">
				...
				<h4 style="margin-top: calc(var(--gap) / 2); margin-bottom: calc(var(--gap) / 2);">
					<a href="<?php echo esc_url( $release_notes_url ); ?>">
						<?php
 printf( __( 'WordPress %s Release Notes' ), $display_major_version ); ?>
					</a>
				</h4>
				<p>
					<?php
 printf( __( 'Read the WordPress %s Release Notes for information on installation, enhancements, fixed issues, release contributors, learning resources, and the list of file changes.' ), $display_major_version ); ?>
				</p>
			</div>
			<div class="column">
				<div class="about__image">
				...
				<h4 style="margin-top: calc(var(--gap) / 2); margin-bottom: calc(var(--gap) / 2);">
					<a href="<?php echo esc_url( $field_guide_url ); ?>">
						<?php
 printf( __( 'WordPress %s Field Guide' ), $display_major_version ); ?>
					</a>
				</h4>
				<p>
					<?php
 printf( __( 'Explore the WordPress %s Field Guide. Learn about the changes in this release with detailed developer notes to help you build with WordPress.' ), $display_major_version ); ?>
				</p>
			</div>
		</div>
